...
⚠️ КРИТИЧНО: увійдіть тим Google-акаунтом, який керує ЦІЛЬОВИМ каналом.
Якщо акаунт має доступ до кількох каналів (бренд-акаунти), Google запитає,
який саме вибрати — виберіть цільовий, інакше відео поїдуть не туди.
